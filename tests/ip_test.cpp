...
//       .m_version_and_length = {.version() = 0, .internet_header_length() =
//       7}, .m_type_of_service = {.precedence() = 3,
//                             .delay() = 1,
//                             .throughput() = 1,
//                             .reliability() = 1,
//                             .reserved() = 3},
...
//     header.m_version_and_length.internet_header_length() = header_length;
//     write_header(header);
...
//   // No need to test > max because max == 0xf = 15, and 16+ doesn't fit in
//   the
//   // 4 bit field
// }
...
//     options_reader::decode_routing(got_option->m_data);
